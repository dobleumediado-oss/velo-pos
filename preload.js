...
const api = {
  ...
  serviceOrders: {
    ...
    addDeposit: (data) => ipcRenderer.invoke('serviceOrders:addDeposit', data),
    refundDeposit: (data) => ipcRenderer.invoke('serviceOrders:refundDeposit', data),
    registerPickupNotice: (data) => ipcRenderer.invoke('serviceOrders:registerPickupNotice', data),
    markAbandoned: (data) => ipcRenderer.invoke('serviceOrders:markAbandoned', data),
    identifierHistory: (data) => ipcRenderer.invoke('serviceOrders:identifierHistory', data),
  ...
  customers: {
    ...
    getBranches:   (data)      => ipcRenderer.invoke('customers:getBranches', data),
    createBranch:  (data)      => ipcRenderer.invoke('customers:createBranch', data),
    updateBranch:  (data)      => ipcRenderer.invoke('customers:updateBranch', data),
    deleteBranch:  (data)      => ipcRenderer.invoke('customers:deleteBranch', data),
    ...
    getCancellationCredits: (data) => ipcRenderer.invoke('customers:getCancellationCredits', data),
  ...
  crm: {
    ...
    warehouseReview:   ()  => ipcRenderer.invoke('crm:warehouseReview'),
    ...
    learningStats:     ()  => ipcRenderer.invoke('crm:learningStats'),
  ...
  sales: {
    ...
    corrections: {
      ...
      updateAdministrative: (data) => ipcRenderer.invoke('sales:corrections:updateAdministrative', data),
      getProductModel:      (data) => ipcRenderer.invoke('sales:corrections:getProductModel', data),
