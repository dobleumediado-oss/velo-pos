...
function buildSidebar() {
  ...
  const adminNavItems = [
    ...
    ...(_adminPuede('module_vendedores') ? [{ key: 'vendedores', icon: 'users', label: 'Colaboradores' }] : []),
  ...
  const cajeroNavItems = [
    ...
    ...(_cajeroPuede('module_vendedores') ? [{ key: 'vendedores', icon: 'users',   label: 'Colaboradores' }]   : []),
