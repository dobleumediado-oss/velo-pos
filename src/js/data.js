...
function newInvObj(id) {
  return {
    ...
    salespersonId: null, disc: 0, discMode: 'pct', discAmtInput: 0,
    discApprovedBy: null, discAuthToken: null, charges: [],
...
function _posWorkspaceCleanInvoice(source, id) {
  ...
  const clean = {
    ...
    discMode: raw.discMode === 'amt' ? 'amt' : 'pct',
    discAmtInput: Math.max(0, Number(raw.discAmtInput) || 0),
    discAuthToken: null,
    discApprovedBy: null,
