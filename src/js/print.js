...
function printReceipt(sale, isReprint = false) {
  ...
  if (plantilla) {
    ...
    const cfg = {
      ...
      invoice_branding_phone:   DB?.settings?.invoice_branding_phone   || '',
      invoice_branding_mobile:  DB?.settings?.invoice_branding_mobile  || '',
      invoice_branding_contact: DB?.settings?.invoice_branding_contact || 'none',
