  ...
  const TOURS = {
    ...
    owner: {
      ...
      steps:[
        ...
        { title:'Gestión de colaboradores', icon:'users', selector:'.nav-item[data-key="vendedores"]', requires:'vendedores', text:'Administra vendedores, mecánicos, personal administrativo, salarios y funciones.' },
